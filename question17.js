...
let myInvitingmsg17 = `I'm very exited to invite at dinner my friend ${myGuestArray17}`;
console.log(myInvitingmsg17);
let message17 = `but unfortunatly my friend ${myGuestArray17[2]} not come at dinner.Ithink invite another friend on dinner`;
