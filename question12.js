...
let myMessage1 = "would you like to learn python?\n";
...
let myMessage2 = "would you like to learn python?\n";
let myMessage3 = ` ${myNameArray2[0]} ${myMessage2} ${myNameArray2[1]} ${myMessage2} ${myNameArray2[2]} ${myMessage2} ${myNameArray2[3]} ${myMessage2} `;
